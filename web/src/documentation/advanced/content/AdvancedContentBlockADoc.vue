...
import { baseFeatures } from '/@src/data/services/advanced/features'
import {
  contentBlockA,
  contentBlockAProps,
  contentBlockASample,
...
<template>
  ...
  <Section id="block-a-props" bordered-bottom>
    <Container>
      ...
      <DemoTabs>
        <template #code>
          <PrismCode language="html" :code="contentBlockA" />
        </template>
        <template #props>
          <DemoProps :props="contentBlockAProps.props" />
        </template>
        <template #sample>
          <PrismCode language="javascript" :code="contentBlockASample" />
        </template>
        <template #usage>
