...
<template>
  <Hero class="scape-hero" alignment="center" >
    <template #body>
            ...
            <div class="has-text-centered mx-auto max-w-5">
              <div class="columns b-columns-half-mobile b-columns-half-tablet-p" >
                <div class="column is-3">
                  <div>
                    <Title tag="h3" :size="3" weight="thin" narrow>
                      <Counter :number="87" />k
                    </Title>
                    <p class="paragraph rem-80 is-uppercase">Job Offers</p>
                  </div>
                </div>
                <div class="column is-3">
                  <div>
                    <Title tag="h3" :size="3" weight="thin" narrow>
                      <Counter :number="230" />k
                    </Title>
                    <p class="paragraph rem-80 is-uppercase">Candidates</p>
                  </div>
                </div>
                <div class="column is-3">
                  <div>
                    ...
                    <p class="paragraph rem-80 is-uppercase">Companies</p>
                  </div>
                </div>
                <div class="column is-3">
                  <div>
                    ...
                    <p class="paragraph rem-80 is-uppercase">Growth</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <template #footer>
      ...
      <DarkImage
        ...
        width="1220" height="250" alt="hero-image"
      />
    </template>
  </Hero>
</template>
