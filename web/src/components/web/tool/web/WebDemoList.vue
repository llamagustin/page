...
//import about from '/@src/texts/tool/web/about'
...
const totalResults = computed(() => {
  return landingDemosFiltered.value.length
  ...
  <div class="vulk-demos">
    ...
    <div v-if="landingDemosFiltered.length > 0" class="demo-section">
      ...
      <div class="columns is-multiline">
        <!-- Demo item -->
        <div
          v-for="(item, index) in landingDemosFiltered.slice(0,1)"
          :key="index"
            ...
            <div class="demo-info has-text-centered">
              <div class="wrapper">
                ...
                <div class="demo-link">
                  <Button
                    class="button-demo"
                    :href="'https://api.aythen.com/template/' + item.route"
                    target="_blank"
                    tabindex="-1"
                  >
                    {{ titleDemo[0].button }}
