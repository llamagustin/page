  ...
  <div class="py-6">
    <div class="testimonial-block columns b-columns-half-tablet-p is-multiline">
      <div
        ...
        :class="columnClasses"
      >
        <div class="testimonial-block-item px-1" :class="blockClasses">
          <i class="iconify text-light mb-4" data-icon="fa:quote-left"></i>
          <p class="paragraph mx-auto cut-words" :class="contentClasses">
            {{ $t('crmTestimonial_content' + index) }}
          </p>
          ...
          <Title tag="h3" :size="7" weight="semi" narrow>
            <span>{{ $t('crmTestimonial_name' + index) }}</span>
          </Title>
...
.cut-words{
  height: 100px; /* ajusta la altura máxima según tus necesidades */
  width: 250px;
  overflow: hidden;
