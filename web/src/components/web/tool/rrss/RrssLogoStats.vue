...
import { textLogoStats } from '/@src/texts/tool/rrs'
...
<template>
  <div class="py-6">
    <CrmLogoStats
      :title="textLogoStats.title"
      :subtitle="textLogoStats.subtitle"
      :heading="textLogoStats.heading"
      :content="textLogoStats.content"
      :logos="customerLogos"
    />
