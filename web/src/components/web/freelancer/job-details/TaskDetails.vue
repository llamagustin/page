...
const filteredbid = ()=>{
  if(!Array.isArray( newbid.value)) newbid.value=[];
  
  const filtered = newbid.value || []
  
  return filtered.filter((bid)=>bid.user_id == props.profile.id)
}
           ...
           <div class="elementscontainer">
             <div class="elementcontainer__titles">
              ...
              <div class="elementscontainer__inputs">
                ...
                <Field class="is-6">
                  <FieldLabel class='input-label' label="Nombre del proyecto"></FieldLabel>
                  <Control>
                    <VInput v-model="formContractInfo.title" placeholder="Inserte el nombre del proyecto" />
                  </Control>
                </Field>
                <Field>
                  <FieldLabel class='input-label' label="Enviar un mensaje privado"></FieldLabel>
                  <Control>
                    <VTextarea v-model="formContractInfo.description" placeholder="Escribe tu mensaje..." />
                  </Control>
                </Field>
               ...
               <div class="elementscontainer__inputs">
                  <div class="radioinput-container">
                    <label class='input-label' for="">Tipo de trabajo</label>
                    <div>
                      <Radio name="radio-1" label="Fixed Price" group="radio-group-1" color="default" />
                      <Radio name="radio-1" label="Hourly Price" group="radio-group-1" color="default" />
                    </div>
                  </div>
               </div>
              <div class="hourlyrate" v-if="formContractInfo.picked == 'hourlyrate'">
               ...
               <div class="elementscontainer__inputs">
                <div class="inputselect">
                    <!--<label v-if="formContractInfo.picked == 'fixedprice'"></label>-->
                 <div class="inputselect-container">
                   <Field class="is-6">
                      <FieldLabel v-if="formContractInfo.picked == 'fixedprice'" label="Tarifa por hora"></FieldLabel>
                      <Control>
                        <VInput v-if="formContractInfo.picked == 'fixedprice'" type="numner" min="1" max="100" placeholder="€ 95 por hora" v-model="formContractInfo.title"  />
                      </Control>
                    </Field>
                    <!--<input class="input-item" type="number" min="1" max="100" placeholder="€ 95 por hora" v-if="formContractInfo.picked == 'fixedprice'" v-model="formContractInfo.tarifa"/>-->
                     <Field>
                      <!--<FieldLabel label="select one"></FieldLabel>-->
                      <Control>
                        <VSelect v-model="formContractInfo.selectedcurrency" :options="optionsCurrency" />
                      </Control>
                    </Field>
                    <Field class="is-6">
                      <FieldLabel v-if="formContractInfo.picked == 'fixedprice'" label="Límite de seguimiento semanal"></FieldLabel>
                      <Control>
                        <VInput type="number" min="1" max="100" placeholder="€ 95 por hora" v-model="formContractInfo.weeklimit"  />
                      </Control>
                    </Field>
                 </div>
                </div>
                <div class="columns is-centered">
                  <Button 
                    ...
                    :disabled="!props.profile.id" 
                    @click="handleSubmit" >
                      Contratar BrightDock
                  </Button>
                  <Button 
                    @click="modalLargeOpen = true" 
                    class="buttons-styles" :long="2" outlined raised>
                    Ver mas
                  </Button>
                </div>
               </div>
            </div>
          <div v-if="false" class="nft-info-tabs">
...
.is-dark{
  ...
  .elementscontainer .elementcontainer__titles{
  color: #fff;
}
