            ...
            <div class="testimonial-item">
              <div class="left-side">
                ...
                <div class="avatar-info">
                  ...
                  <div v-for="(newSlide, index) in slide.skills.Programs" :key="index">
                           <p>{{newSlide}}</p>
                  </div>
                  <div v-for="(newSlide, index) in slide.skills.Frameworks" :key="index">
                          <p>{{newSlide}}</p>
                  </div>
                  <!--div v-for="(newSlide, index) in slide.skills.ProgrammingLanguages" :key="index">
                          <p>{{newSlide}}</p>
                  </div-->
                </div>
              </div>
              <div class="right-side">
                ...
                <div class="testimonial-content">
                  <p class="text-content">"{{ slide.about }}"</p>
                  <div class="metrics">
                    <div class="metric">
                      <!--i-ph-lightning-duotone /-->
                      <div class="meta">
                        <span>Country</span>
                        <span>{{ slide.address.country}}</span>
                      </div>
                    </div>
                    <div class="metric">
                      <!--i-ph-crown-duotone /-->
