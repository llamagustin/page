...
<template>
  <div v-if="props.subarticle" class="help-container">
    <div class="flex-card single-help-article">
      <div class="article-inner">
        <Title tag="h2" :size="3">
          <span>{{ props.subarticle.title }}</span>
        </Title>
        <Subtitle tag="h3" :size="5">
          <span>{{ props.subarticle.text }}</span>
        </Subtitle>
        ...
        <!--</div>-->
        <div v-for="resume in props.subarticle.resume">
          <div class="content">
            <b>{{resume.title}}:&nbsp;</b>
            <!--<Markdown :source="props.article.content" />-->
            {{ resume.text }}
