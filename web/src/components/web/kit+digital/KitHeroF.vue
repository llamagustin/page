...
import { intro, heroScreenshots } from '/@src/texts/kit+digital'
</script>
          ...
          <div class="py-6">
            <div class="hero-text">
              <Title
                ...
                leading
              >
                <span class="text-gradient">{{ intro.title }}</span>
              </Title>
              <h4 class="midtitle">
                {{ intro.subtitle }}
                <Tag
              ...
              <Buttons>
                <Button
                  ...
                  "
                >
                  {{ intro.botton[0].label }}
                </Button>
                <Button
                  elevated
                  bold
                  :long="2"
                  :href="intro.botton[1].to"
                  target=""
                >
                  {{ intro.botton[1].label }}
                </Button>
              </Buttons>

              <div class="mt-12 stack-icons">
                <DarkImage
