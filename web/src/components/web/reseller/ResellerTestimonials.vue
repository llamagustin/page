    ...
    <MarqueeText :repeat="10" :duration="40">
      <div class="marquee-testimonials-inner">
        <div class="row">
          ...
          >
            <div class="head">
              <AvatarSimple :picture="testimonial.avatar" size="medium" />
              <div class="meta">
                <span>{{ $t('resellerTestimonials_name'+index) }}</span>
                <span>{{ $t('resellerTestimonials_position'+index) }}</span>
              </div>
              <!--
              <img
                class="logo"
            ...
            <div class="body">
              <p>{{ $t('resellerTestimonials'+index) }}</p>
            </div>
          </div>
        </div>
      </div>
