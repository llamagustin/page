...
import { textSocial } from '/@src/texts/reseller'
</script>
      ...
      <div class="tab-outer">
        ...
        <transition name="fade-slow" mode="out-in">
          <div v-if="activeTab === 'tab2'" class="tab-inner">
            ...
            /-->
              <iframe
                  src="/assets/docs/KitDigital-Información.pdf"
                  frameBorder="0"
                  scrolling="auto"
                  loading="lazy"
                  height="600px"
