...
import { textHeroN } from '/@src/texts/reseller'
        ...
        <div class="column is-relative">
          <div class="mx-auto max-w-6 mb-4">
            <Title tag="h1" :size="1" weight="bold">
              <span>
                {{ textHeroN.title[0] }}
                <span class="text-primary">{{ textHeroN.title[1] }}</span>
              </span>
            </Title>
            <Subtitle
              tag="p"
            ...
            <div class="buttons is-relative z-1">
              <Button
                color="primary"
                :href="textHeroN.button[0].link"
                target="_blank"
                :long="2"
                raised
                bold
              >
                {{ textHeroN.button[0].label }}
              </Button>
              <Button
                :href="textHeroN.button[1].link"
                target="_blank"
                elevated
                bold
                :long="2"
              >
                {{ textHeroN.button[1].label }}
              </Button>
            </div>
          </div>
          ...
          <div class="centered-app-wrapper mx-auto max-w-8 mt-6">
            <DarkImage
              ...
              src="/assets/illustrations/apps/webinar-reseller.png"
              src-dark="/assets/illustrations/apps/webinar-reseller.png"
              width="1200"
              height="724"
              alt="Hero mockup"
            />
            ...
            <a
              href="https://www.youtube.com/channel/UCHHiSuZ8TraiGtgB5UWxQyQ"
              target="_blank"
...
.centered-app-wrapper .first-video {
    position: fixed;
    top: 0px;
    left: 0;
    min-width: 100%;
