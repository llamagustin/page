      ...
      <div class="pricing-action-box">
        ...
        <div class="pricing-action-box-inner">
          ...
          <div class="meta">
            <Title tag="h3" :size="5" weight="semi" narrow>
              €{{ props.priceDiscount }}/mes
            </Title>
            <p class="paragraph rem-90">
              {{ props.hourlyDiscount }} horas de desarrollo
            </p>
          </div>
          <div class="ml-auto">
        ...
        <div class="pricing-action-box-inner">
          ...
          <div class="meta">
            ...
            <p class="paragraph rem-90">
              {{ props.hourlyTeam }} horas de desarrollo
            </p>
          </div>
        </div>
      </div>
      <div class="button-wrap">
        <Button to="/team/freelancer" color="primary" size="medium" fullwidth raised>
          Calcular coste de equipo
        </Button>
      </div>
    </div>
  </div>
