...
export type SectionColor = 'greydarker' | 'grey' | 'darker' | 'primary' | 'gradient' | 'steelblue'
...
const props = withDefaults(defineProps<SectionProps>(), {
  ...
  wave: undefined,
  tongue: undefined,
  shapeColor: 'grey', //cambiar el color del shape añadiendo un color
  overlay: false,
})

const sectionClasses = computed(() => [
  props.size && `is-${props.size}`,
  props.color && `is-${props.color}`, //color que le llega por props
...
console.log("sectionClasses", props.shapeColor)
</script>
...
.section {
  ...
  &.section-wave-1 {
    padding-bottom: 5.875rem; /*9.875rem*/
  }

  &.section-wave-2 {
    padding-bottom: 6.875rem; /*9.875rem*/
  }
