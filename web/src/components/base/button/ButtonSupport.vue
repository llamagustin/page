...
const button = [{
  ...
  label: 'aythen.eu',
  link: 'https://www.instagram.com/aythen.eu/',
}]
</script>
...
<template>
    <div class="buttons cta-content is-centered mt-5">
        <Button
          color="dark"
          :long="2"
          :href="button[0].link"
