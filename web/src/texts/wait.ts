...
export const textHero = {
  title: ['Estamos dejándolo', 'todo listo'],
  date: 'Jun 31, 2023',
  subtitle: 'Disculpa las molestias',
  label: ['días', 'horas', 'minutos', 'segundos']
}

export const textPanel = [
  {
    title: 'Group workshops',
    content: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quae cum
          essent dicta, finem fecimus et ambulandi et disputandi.`,
    label: 'Learn More',
  },
  {
    title: '400,000+ attendees',
    content: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quae cum
          essent dicta, finem fecimus et ambulandi et disputandi.`,
    label: 'Learn More',
  },
...
export const textBenefits = {
  labels: [
    { label: 'Javascript', value: 'javascript', default: true },
