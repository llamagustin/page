  ...
  <div :style="{ marginTop: '3%' }">
    <div class="text-center">
      <!--<template v-if="formSubmitted">-->
        ...
        <p class="mb-5" >En breves uno de nuestros agentes mensajes de aquise pondrá en contacto contigo para ayudarle en su proceso hacía la digitalización. Vamos a trabajar en el Kit Digital ideal para tí. Si tienes preguntas que resolver no dude en solicitar su cita prevía.</p>
      <!--</template>-->
