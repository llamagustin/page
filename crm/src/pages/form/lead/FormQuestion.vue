...
const {questionsAnswered, show, clearCreditCard, dataForm } = defineProps<Props>();
...
const nextQuestion = () => {
  ...
  // console.log('33', questionsAnswered, indexIncrement)
  // if (questionsAnswered >= 13) {
  //   show(5)
  //   // isValid.value = true;
  // }else if (indexIncrement >= 13){
  //   showAlertTimeOut()
  // }
  ...
  show(5)
  // let index = showQuestion.value.indexOf(false);
