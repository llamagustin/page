...
const axiosIns = axios.create({
  ...
  // console..log('wdiwjdijwe', devicesInit)
    ...
    const deleteDevices = async (id) => {
      ...
      var res = await axiosIns.post('/account/delete/devices', data) 
  ...
  async function registerDevice() {
    ...
    //     // if(val.active.state == 'activated'){
    //     //   registerActive.value = ref(true)
    //     // }
    //   }).catch(err => {
    //     console.log('e', err)
    //   })
...
const saveNotifications = () => {
  ...
  async function pushNotification(){
    ...
    var res = await axiosIns.post('/devices/send', data)
      ...
      <VCard title="Dispositivos Recientes">
        <template #append>
          <div v-if="registerPemission">
            <VBtn @click="pushNotification" prepend-icon="tabler-plus" size="small">
              Push
            </VBtn>
        ...
        <VTable class="text-no-wrap">
          ...
          <tbody v-if="devices">
            <tr v-for="(device, key) in devices" :key="key">
              ...
              <td>
                <VBtn @click="deleteDevices(device.id)" size="small">
