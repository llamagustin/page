...
// console.log('tools: ', props.data.tools)
// if(props.data.tools){
...
const changeTool = async (tool: any) => {
  ...
  // console.log('change tool', props.data.tools, tool)
  //props.data[tool.index] = tool.data
...
// watch(users,val => {
//   console.log('console', users.value, props.data)
//   // props.data = client.value;
// });
